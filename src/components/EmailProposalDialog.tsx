...
<div style="font-family: Arial, sans-serif; font-size: 14px; line-height: 1.6; color: #333;">
  ...
  <ul>
    ...
    <li>We offer a 2% discount on your total monthly invoice if you pay electronically and within 10 days after the invoice was sent out.</li>
  </ul>
  <p>Please find the attached ${subjectParts.join(" and ").toLowerCase()} for your review.</p>
  <p>The quote is for <strong>$${totalBill.toFixed(2)}</strong>. We know we provide the best value in the market and we will be honored to prove that to you. Our team is equipped with the expertise, equipment, and dedication to deliver these benefits consistently. We take pride in our attention to detail and our commitment to meeting your specific cleaning needs.</p>
